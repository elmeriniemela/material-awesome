...
```
git clone https://github.com/elmeriniemela/material-awesome.git ~/.config/awesome
```
...
```
git clone -b awesome-4.2 https://github.com/elmeriniemela/material-awesome.git ~/.config/awesome
```
